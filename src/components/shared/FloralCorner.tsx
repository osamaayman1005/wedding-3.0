  ...
  return (
    ...
    >
      ...
      <g fill="none" strokeLinecap="round" strokeLinejoin="round">
        <path
          d="M28 176c36-32 56-63 70-116"
          stroke={`url(#${leafId})`}
          strokeWidth="4"
        />
        <path
          d="M46 158c12-15 25-24 42-29"
          stroke={`url(#${leafId})`}
          strokeWidth="3"
        />
        <path
          d="M70 132c9-13 21-21 36-25"
          stroke={`url(#${leafId})`}
          strokeWidth="3"
        />
        <path
          d="M84 106c8-10 18-15 30-18"
          stroke={`url(#${leafId})`}
          strokeWidth="3"
        />
        <ellipse
